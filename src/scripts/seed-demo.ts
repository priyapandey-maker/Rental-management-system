...
const VENDORS = [
  { id: 'vendor-01', email: 'vendor@rentalms.local', name: 'Demo Vendor', company: 'TechRent Solutions' },
  { id: 'vendor-02', email: 'camera@rentalms.local', name: 'Cam Vendor', company: 'CameraHub Rentals' },
  { id: 'vendor-03', email: 'furniture@rentalms.local', name: 'Furn Vendor', company: 'Urban Furniture Rentals' },
  { id: 'vendor-04', email: 'event@rentalms.local', name: 'Event Vendor', company: 'EventGear India' },
  { id: 'vendor-05', email: 'home@rentalms.local', name: 'Home Vendor', company: 'HomeEase Rentals' },
  { id: 'vendor-06', email: 'gaming@rentalms.local', name: 'Game Vendor', company: 'ProGaming Rentals' },
  { id: 'vendor-07', email: 'office@rentalms.local', name: 'Office Vendor', company: 'OfficeTech Rentals' },
  { id: 'vendor-08', email: 'smart@rentalms.local', name: 'Smart Vendor', company: 'SmartLiving Rentals' },
  { id: 'vendor-09', email: 'drone@rentalms.local', name: 'Drone Vendor', company: 'AeroRentals' },
  { id: 'vendor-10', email: 'audio@rentalms.local', name: 'Audio Vendor', company: 'SoundStage Rentals' },
];

const CUSTOMERS = [
  { id: 'cust-demo-01', email: 'cust-demo-01@rentalms.local', fn: 'Demo', ln: 'Customer', city: 'Mumbai' },
  { id: 'cust-02', email: 'cust-02@rentalms.local', fn: 'Aarav', ln: 'Sharma', city: 'Delhi' },
  { id: 'cust-03', email: 'cust-03@rentalms.local', fn: 'Priya', ln: 'Patel', city: 'Bengaluru' },
  { id: 'cust-04', email: 'cust-04@rentalms.local', fn: 'Rohan', ln: 'Das', city: 'Kolkata' },
  { id: 'cust-05', email: 'cust-05@rentalms.local', fn: 'Ananya', ln: 'Sen', city: 'Hyderabad' },
  { id: 'cust-06', email: 'cust-06@rentalms.local', fn: 'Kabir', ln: 'Roy', city: 'Pune' },
  { id: 'cust-07', email: 'cust-07@rentalms.local', fn: 'Meera', ln: 'Kapoor', city: 'Chennai' },
  { id: 'cust-08', email: 'cust-08@rentalms.local', fn: 'Aditya', ln: 'Singh', city: 'Ahmedabad' },
  { id: 'cust-09', email: 'cust-09@rentalms.local', fn: 'Neha', ln: 'Gupta', city: 'Jaipur' },
  { id: 'cust-10', email: 'cust-10@rentalms.local', fn: 'Vikram', ln: 'Malhotra', city: 'Surat' },
  { id: 'cust-11', email: 'cust-11@rentalms.local', fn: 'Sneha', ln: 'Joshi', city: 'Lucknow' },
  { id: 'cust-12', email: 'cust-12@rentalms.local', fn: 'Rahul', ln: 'Verma', city: 'Kanpur' },
  { id: 'cust-13', email: 'cust-13@rentalms.local', fn: 'Pooja', ln: 'Nair', city: 'Nagpur' },
  { id: 'cust-14', email: 'cust-14@rentalms.local', fn: 'Arjun', ln: 'Menon', city: 'Indore' },
  { id: 'cust-15', email: 'cust-15@rentalms.local', fn: 'Divya', ln: 'Bhat', city: 'Thane' },
  { id: 'cust-16', email: 'cust-16@rentalms.local', fn: 'Karan', ln: 'Mehta', city: 'Bhopal' },
  { id: 'cust-17', email: 'cust-17@rentalms.local', fn: 'Rhea', ln: 'Chopra', city: 'Visakhapatnam' },
  { id: 'cust-18', email: 'cust-18@rentalms.local', fn: 'Dev', ln: 'Anand', city: 'Pimpri-Chinchwad' },
  { id: 'cust-19', email: 'cust-19@rentalms.local', fn: 'Tara', ln: 'Sutaria', city: 'Patna' },
  { id: 'cust-20', email: 'cust-20@rentalms.local', fn: 'Isha', ln: 'Ambani', city: 'Vadodara' },
  { id: 'cust-21', email: 'cust-21@rentalms.local', fn: 'Yash', ln: 'Chopra', city: 'Ghaziabad' },
  { id: 'cust-22', email: 'cust-22@rentalms.local', fn: 'Kriti', ln: 'Sanon', city: 'Ludhiana' },
  { id: 'cust-23', email: 'cust-23@rentalms.local', fn: 'Varun', ln: 'Dhawan', city: 'Agra' },
  { id: 'cust-24', email: 'cust-24@rentalms.local', fn: 'Alia', ln: 'Bhatt', city: 'Nashik' },
  { id: 'cust-25', email: 'cust-25@rentalms.local', fn: 'Siddharth', ln: 'Malhotra', city: 'Faridabad' },
  { id: 'cust-26', email: 'cust-26@rentalms.local', fn: 'Kiara', ln: 'Advani', city: 'Meerut' },
  { id: 'cust-27', email: 'cust-27@rentalms.local', fn: 'Tiger', ln: 'Shroff', city: 'Rajkot' },
  { id: 'cust-28', email: 'cust-28@rentalms.local', fn: 'Disha', ln: 'Patani', city: 'Kalyan' },
  { id: 'cust-29', email: 'cust-29@rentalms.local', fn: 'Hrithik', ln: 'Roshan', city: 'Vasai-Virar' },
  { id: 'cust-30', email: 'cust-30@rentalms.local', fn: 'Deepika', ln: 'Padukone', city: 'Varanasi' }
];
