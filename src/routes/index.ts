...
vendorRouter.post('/transactions/:id/return-request', orchestrationController.requestReturnTransaction);
vendorRouter.post('/transactions/:id/return-approve', orchestrationController.approveReturnTransaction);
vendorRouter.post('/transactions/:id/return-receive', orchestrationController.receiveReturnTransaction);
vendorRouter.post('/transactions/:id/inspect', orchestrationController.inspectTransaction);
vendorRouter.post('/transactions/:id/resolve', orchestrationController.resolveTransaction);
vendorRouter.post('/transactions/:id/complete', orchestrationController.completeTransaction);
...
legacyRouter.post('/transactions/:id/cancel', transactionController.cancelTransaction);
  ...
  legacyRouter.post('/transactions/:id/return-request', orchestrationController.requestReturnTransaction);
  legacyRouter.post('/transactions/:id/return-approve', orchestrationController.approveReturnTransaction);
  legacyRouter.post('/transactions/:id/return-receive', orchestrationController.receiveReturnTransaction);
  legacyRouter.post('/transactions/:id/inspect', orchestrationController.inspectTransaction);
  legacyRouter.post('/transactions/:id/resolve', orchestrationController.resolveTransaction);
  legacyRouter.post('/transactions/:id/complete', orchestrationController.completeTransaction);
