    ...
    <div className="max-w-7xl mx-auto space-y-8 text-gray-900 pb-12">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-6">
          {items.length === 0 ? (
            <div className="bg-white p-12 border border-gray-200 rounded-2xl text-center shadow-xl">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden divide-y divide-gray-200 shadow-xl">
              {items.map((item, idx) => (
                <div key={idx} className="p-6 sm:p-8 flex flex-col sm:flex-row gap-6">
                  {/* Image Container */}
                  <div className="w-full sm:w-32 h-32 bg-gray-50 border border-gray-200 rounded-xl flex items-center justify-center flex-shrink-0 relative overflow-hidden">
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      ...
                      <div className="flex space-x-4">
                        <button onClick={() => saveForLater(idx)} className="text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors flex items-center">
        ...
        <div className="w-full lg:w-96 flex-shrink-0">
          <div className="bg-white border border-gray-200 rounded-2xl p-6 sticky top-24 shadow-xl">
            ...
            <div className="space-y-4">
              <div className="flex relative">
                ...
                <button 
                  ...
                  className="bg-gray-100 border-y border-r border-gray-300 text-gray-900 px-5 py-2.5 rounded-r-lg text-sm font-bold hover:bg-gray-200 transition-colors"
                >
                  Apply
                </button>
              </div>
              ...
              <div className="pt-6 border-t border-gray-200 space-y-3">
                ...
                <button 
                  disabled={items.length === 0}
                  onClick={() => navigate('/store/delivery')}
                  className="w-full bg-gray-100 hover:bg-gray-200 border border-gray-300 text-gray-900 font-bold py-3.5 rounded-xl shadow flex justify-center items-center transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Pay with Saved Card
                </button>
              </div>
